...
?>
            ...
            <tbody>
				...
				<?PHP
					$query = $this->manipulasi_hasil_m->view();
				...
				<tr>
					<td>
						<?PHP echo $row->id_hasil; ?>
						<input type="hidden" id="manipulasi_admin_<?PHP echo $row->id_hasil; ?>" value="<?PHP echo $row->id_pengajar; ?>">
						<input type="hidden" id="manipulasi_admin1_<?PHP echo $row->id_hasil; ?>" value="<?PHP echo $row->nilai; ?>">
					</td>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#delete_all').click(function() {
			window.location = '<?PHP echo site_url(); ?>manipulasi_hasil/delete_all';
		});
